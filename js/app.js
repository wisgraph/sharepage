import { navigate, initRouter } from './router.js?v=7777';
import { BASE_PATH, IS_LOCAL } from './utils.js?v=7777';
import { initTOCToggle } from './toc.js?v=7777';
import { goToPage } from './dashboard.js?v=7777';
