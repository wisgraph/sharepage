...
import { fetchFile } from '../core/fileApi.js?v=1771153024397';
import { processDocument } from '../services/docService.js?v=1771153024397';
import { renderDocumentView, renderError, renderLoading, prepareLayout } from '../views/docView.js?v=1771153024397';
import { initImageViewer } from '../views/imageViewer.js?v=1771153024397';
import { initCodeUtils } from '../views/codeView.js?v=1771153024397';
import { initLinkPreviews } from '../views/previewView.js?v=1771153024397';
import { renderTOC, initScrollHighlight } from '../views/tocView.js?v=1771153024397';
import { initScrollAnimations, cleanupScrollAnimations, initDashboardAnimations } from '../views/animations.js?v=1771153024397';
import { loadDashboardNotes } from '../services/dashboardService.js?v=1771153024397';
import { renderDashboardPage } from '../views/dashboardView.js?v=1771153024397';
