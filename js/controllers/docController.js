...
import { fetchFile } from '../core/fileApi.js?v=1771153053678';
import { processDocument } from '../services/docService.js?v=1771153053678';
import { renderDocumentView, renderError, renderLoading, prepareLayout } from '../views/docView.js?v=1771153053678';
import { initImageViewer } from '../views/imageViewer.js?v=1771153053678';
import { initCodeUtils } from '../views/codeView.js?v=1771153053678';
import { initLinkPreviews } from '../views/previewView.js?v=1771153053678';
import { renderTOC, initScrollHighlight } from '../views/tocView.js?v=1771153053678';
import { initScrollAnimations, cleanupScrollAnimations, initDashboardAnimations } from '../views/animations.js?v=1771153053678';
import { loadDashboardNotes } from '../services/dashboardService.js?v=1771153053678';
import { renderDashboardPage } from '../views/dashboardView.js?v=1771153053678';
