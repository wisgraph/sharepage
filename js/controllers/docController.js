...
import { fetchFile } from '../core/fileApi.js?v=1771235240472';
import { processDocument } from '../services/docService.js?v=1771235240472';
import { renderDocumentView, renderError, renderLoading, prepareLayout } from '../views/docView.js?v=1771235240472';
import { initImageViewer } from '../views/imageViewer.js?v=1771235240472';
import { initCodeUtils } from '../views/codeView.js?v=1771235240472';
import { initLinkPreviews } from '../views/previewView.js?v=1771235240472';
import { renderTOC, initScrollHighlight } from '../views/tocView.js?v=1771235240472';
import { initScrollAnimations, cleanupScrollAnimations, initDashboardAnimations } from '../views/animations.js?v=1771235240472';
import { loadDashboardNotes } from '../services/dashboardService.js?v=1771235240472';
import { renderDashboardPage } from '../views/dashboardView.js?v=1771235240472';
import { initDashboardHandlers } from './dashboardController.js?v=1771235240472';
